        ...
        <div className="order-1 w-full mt-20 md:w-1/2 md:ml-12 md:h-[500px] glass text-left p-10">
          <div id="image-zoom">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                Rule 1: Always be respectful. Lorem ipsum dolor sit, amet
                consectetur adipisicing elit. Optio iure magni aspernatur!
                Voluptatum!
              </li>
              <li>
                Rule 2: Follow the community guidelines. Lorem ipsum dolor, sit
                amet consectetinima sapiente at dolorem velit sit exercitationem
                dignissimos quo?
              </li>
              <li>
                Rule 3: Keep your profile information up-to-date. Lorem ipsum
                dolor sit amet consectetur adipisicing elit. Voluptates
                repudiandae, neque nesciunt nis cumque est at quibusdam!
              </li>
              <li>
                Rule 4: Report any suspicious activity. Lorem ipsum dolor sit
                amet consecitecto labore aliquid natu non omnis provident modi
                inventore, deleniti minima.
              </li>
              <li>
                Rule 5: Enjoy your time here! Lorem ipsum dolor sistiae qudolore
                eaque similique, dolores aliquam molestias dicta eligendi
                aperiam?
              </li>
            </ul>
          </div>
